...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction().replace(R.id.content_frame,new RideListFragment()).commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_becomeDriver) {
            fragmentManager.beginTransaction().replace(R.id.content_frame, new BecomeDriverFragment()).commit();
